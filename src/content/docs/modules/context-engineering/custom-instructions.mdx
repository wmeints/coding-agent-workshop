...
- **Starter code**: [labs/tools/003-text-editor-plugin/][LAB_START_SOURCE]
- **Solution code**: [labs/context-engineering/001-custom-instructions/][LAB_SOLUTION_SOURCE]
...
Find the solution for the lab here: [labs/context-engineering/001-custom-instructions/][LAB_SOLUTION_SOURCE]

[LAB_START_SOURCE]: https://github.com/wmeints/coding-agent-workshop/tree/main/labs/tools/003-text-editor-plugin
[LAB_SOLUTION_SOURCE]: https://github.com/wmeints/coding-agent-workshop/tree/main/labs/context-engineering/001-custom-instructions