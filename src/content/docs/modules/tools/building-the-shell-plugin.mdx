...
- **Starter:** [labs/tools/001-context-awareness][LAB_START_SOURCE]
- **Solution:** [labs/tools/002-shell-plugin][LAB_SOLUTION_SOURCE]
...
Please find the solution for the lab here: [labs/tools/002-shell-plugin/solution][LAB_SOLUTION_SOURCE].

[LAB_START_SOURCE]: https://github.com/wmeints/coding-agent-workshop/tree/main/labs/tools/001-context-awareness
[LAB_SOLUTION_SOURCE]: https://github.com/wmeints/coding-agent-workshop/tree/main/labs/tools/002-shell-plugin