...
import agentArchitectureStep2 from '../../../../assets/agent-architecture-step-2.png';

<MarpSlides moduleName="tools" />
...
<CaptionedImage src={agentArchitectureStep2} alt="Agent Tools Architecture - Items implemented in this module are highlighted in blue" />
