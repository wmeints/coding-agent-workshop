...
- **Starter:** [labs/agent-loop/004-testing-agents][LAB_START_SOURCE]
- **Solution:** [labs/tools/001-context-awareness][LAB_SOLUTION_SOURCE]
...
1. Update the `AgentSystemInstructions.txt` embedded resource to include
   template variables for the operating system and working directory.

   ```handlebars title="Resources/AgentSystemInstructions.txt"
   You're a coding agent built by Bitbash. Your task is to help the developer solve programming tasks.
...
The agent now has awareness of its environment, which will be essential when
adding shell execution capabilities in future labs. You can find the complete
solution in [labs/tools/001-context-awareness][LAB_SOLUTION_SOURCE].

[LAB_START_SOURCE]: https://github.com/wmeints/coding-agent-workshop/tree/main/labs/agent-loop/004-testing-agents
[LAB_SOLUTION_SOURCE]: https://github.com/wmeints/coding-agent-workshop/tree/main/labs/tools/001-context-awareness