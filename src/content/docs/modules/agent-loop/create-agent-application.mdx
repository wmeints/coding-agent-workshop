...
[labs/agent-loop/001-setup-application][SOLUTION_FILES] folder. You can use
...
[SOLUTION_FILES]: https://github.com/wmeints/coding-agent-workshop/tree/main/labs/agent-loop/001-setup-application/
