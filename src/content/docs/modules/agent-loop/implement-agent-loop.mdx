...
- **Starter:** [labs/agent-loop/001-setup-application](/labs/agent-loop/001-setup-application)
- **Solution:** [labs/agent-loop/002-main-agent-loop](/labs/agent-loop/002-main-agent-loop)
...
1. Download [SystemInstructions.txt][AGENT_INSTRUCTIONS] and place it in the `Resources`
...
[AGENT_INSTRUCTIONS]: https://raw.githubusercontent.com/wmeints/coding-agent-workshop/refs/heads/main/labs/agent-loop/002-agent-interface/CodingAgent/Resources/AgentSystemInstructions.txt