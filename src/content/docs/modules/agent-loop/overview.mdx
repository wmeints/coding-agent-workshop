...
import agentArchitectureStep1 from '../../../../assets/agent-architecture-step-1.png';

<MarpSlides moduleName="agent-loop" />
...
<CaptionedImage src={agentArchitectureStep1} alt="Agent Architecture - Items implemented in this module are highlighted in blue" />
