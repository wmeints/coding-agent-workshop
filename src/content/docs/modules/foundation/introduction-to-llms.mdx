...
import transformerArchitecture from '../../../../assets/transformer-architecture.png';
...
<CaptionedImage
      src={transformerArchitecture}
      alt="Transformer architecture diagram showing input projection to vectors, transformer block, and output projection"
/>
...
<Aside title="Why use tokens and vectors?">
...
human reasoning. LLMs don't truly understand concepts—they predict text patterns
...
<Aside title="Is this real reasoning?">
